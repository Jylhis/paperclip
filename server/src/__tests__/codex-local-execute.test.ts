...
describe("codex execute", () => {
  it("uses a Paperclip-managed CODEX_HOME outside worktree mode while only preserving shared config", async () => {
    ...
    try {
      ...
      await expect(fs.lstat(path.join(managedCodexHome, "auth.json"))).rejects.toThrow();
