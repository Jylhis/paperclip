...
describe("realizeExecutionWorkspace", () => {
  ...
  it("rejects branch reuse when the matching branch is checked out at the primary repo", async () => {
    ...
    ).rejects.toThrow(/outside the configured execution worktree path/);
  });
