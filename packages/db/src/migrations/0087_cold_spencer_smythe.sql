CREATE TYPE "public"."board_api_key_requested_access" AS ENUM('board', 'instance_admin_required');--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "board_api_keys" ADD COLUMN "requested_access" "board_api_key_requested_access" DEFAULT 'board' NOT NULL;--> statement-breakpoint
