DROP TABLE IF EXISTS "feedback_exports" CASCADE;--> statement-breakpoint
...
ALTER TABLE "feedback_votes" DROP COLUMN IF EXISTS "redaction_summary";--> statement-breakpoint
...
ALTER TABLE "companies" DROP COLUMN IF EXISTS "feedback_data_sharing_terms_version";
