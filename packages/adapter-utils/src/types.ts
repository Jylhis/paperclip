...
export type TranscriptEntry =
  ...
  | { kind: "result"; ts: string; text: string; inputTokens: number; outputTokens: number; cachedTokens: number; cacheCreationTokens?: number; costUsd: number; subtype: string; isError: boolean; errors: string[] }
